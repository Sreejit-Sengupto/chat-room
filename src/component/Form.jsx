  ...
  return (
    <>
      ...
      <div className="flex flex-col mobile lg:h-screen justify-center items-center">
        <p className="text-white font-lexend text-xl mb-5">Welcome to Helping Group <span className="text-xs text-blue-400 font-mono ml-1 border border-blue-700 px-2 rounded-sm">
            on web
          </span></p>
